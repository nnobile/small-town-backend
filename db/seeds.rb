...
sherwood_mug = Item.create(merchant_id: 1, name: "Sherwood Diner Coffee Mug", category: "Drinkware", description: "Classic Sherwood diner coffee mug. 16oz", price: 12.00, image_url: "https://pbs.twimg.com/media/ETUPnPpWoAANuHZ?format=jpg&name=large")
